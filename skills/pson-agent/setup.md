...
All 21 routes are documented in [docs/api/api-contract.md](https://github.com/fredabila/pson5/blob/main/docs/api/api-contract.md) with auth, scopes, and response shapes.
...
- Browse [github.com/fredabila/pson5/tree/main/examples](https://github.com/fredabila/pson5/tree/main/examples) for more demos.
